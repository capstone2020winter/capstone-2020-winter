...
export class BudgetFaqsPage implements OnInit {
  ...
  constructor() {   
      ...
      this.questions = [
          ...
          {expanded: false, name: "Tips to help you stick to your Budget.", 
          text: "Limit your spending to what is in your budget.Keep track of receipts and bills.Compare your budget to what you actually spend at the end of each month.Make adjustments to your budget if income and expenses change.When comparing your budget to your actual spending, ask yourself the following questions:Are there big or small differences between your actual spending and budget.Where are the largest differences, can I make changes to suit my goals. Are differences because of an unusual situation or is this likely to happen each month.Adjust your budget as necessary: Adjust your Income or Expenses.	Are you able to save enough money to reach your financial goals or pay off your debts.Your budget is a continuous work in-progress. Tracking your income and expenses to meet your financial goals"}    
